...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <asp:Panel ID="pnlGrvUsuarios" runat="server">
        <div class="container mt-3">
            ...
            <asp:GridView ID="grvUsuarios" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="IdUsuario" ForeColor="#333333" GridLines="None" OnRowEditing="grvClientes_RowEditing" OnRowDeleting="grvClientes_RowDeleting">
